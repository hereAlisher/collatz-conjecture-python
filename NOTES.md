# My Notes — Collatz Conjecture

> This file is my personal space to document thoughts, research findings, and impressions
> as I explore the Collatz Conjecture. Updated as I learn more.
...
|-------|-------|------------|-------------|
| 6     | 8     | 16         | Simple and clean — drops to 1 quickly |
| 27    | 111   | 9,232      | Shocked me — starts small, explodes to 9232, then collapses |
| 97    | 118   | 7,274      | Even higher step count than 27 despite being a smaller number |
| 128   | 7     | 128        | Power of 2 — just keeps halving, no drama at all |
| 871   | 178   | 190,996    | The peak here is insane — nearly 220x the starting value |
| 1     | 0     | 1          | Edge case — already at 1, nothing happens |
| 2     | 1     | 2          | One step, done. The simplest possible case |
...
Computationally, it has been verified for all numbers up to **2⁶⁸** 
(roughly 295 quintillion). That's an enormous range, yet it still doesn't 
count as a mathematical proof — you can't check infinity by counting.

What makes it so hard to prove is that the sequence behaves unpredictably.
There is no known formula to tell you in advance how many steps a number 
